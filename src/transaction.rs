...
mod tests {
    ...
    fn test_sign_taproot_vector() {
        ...
        fn traverse(tree: &Tree) -> (Vec<LeafInfo>, [u8; 32]) {
            match tree {
                Tree::Leaf { script, version } => {
                    ...
                    (
                        vec![LeafInfo { hash: h, version: *version, path: Vec::new() }],
                        h,
                    )
                }
                Tree::Node(l, r) => {
        ...
        fn tweak_key(pk: &k256::schnorr::VerifyingKey, merkle: Option<[u8; 32]>) -> ([u8; 32], ProjectivePoint) {
        ...
        fn control_block(version: u8, int_pk: &[u8; 32], parity: bool, path: &[[u8; 32]]) -> Vec<u8> {
            let mut v = Vec::new();
        ...
        let vectors = [
            ...
            Vector {
                ...
                tree: Some(Tree::Leaf { script: "20d85a959b0290bf19bb89ed43c916be835475d013da4b362117393e25a48229b8ac", version: 192 }),
                leaf_hashes: &["5b75adecf53548f3ec6ad7d78383bf84cc57b55a3127c72b9a2481752dd88b21"],
                merkle_root: Some("5b75adecf53548f3ec6ad7d78383bf84cc57b55a3127c72b9a2481752dd88b21"),
                ...
                control_blocks: &["c1187791b6f712a8ea41c8ecdd0ee77fab3e85263b37e1ec18a3651926b3a6cf27"],
            },
            Vector {
                internal_pubkey: "93478e9488f956df2396be2ce6c5cced75f900dfa18e7dabd2428aae78451820",
                tree: Some(Tree::Leaf { script: "20b617298552a72ade070667e86ca63b8f5789a9fe8731ef91202a91c9f3459007ac", version: 192 }),
                leaf_hashes: &["c525714a7f49c28aedbbba78c005931a81c234b2f6c99a73e4d06082adc8bf2b"],
                merkle_root: Some("c525714a7f49c28aedbbba78c005931a81c234b2f6c99a73e4d06082adc8bf2b"),
                ...
                control_blocks: &["c093478e9488f956df2396be2ce6c5cced75f900dfa18e7dabd2428aae78451820"],
            },
            Vector {
                internal_pubkey: "ee4fe085983462a184015d1f782d6a5f8b9c2b60130aff050ce221ecf3786592",
                tree: Some(Tree::Node(
                    Box::new(Tree::Leaf { script: "20387671353e273264c495656e27e39ba899ea8fee3bb69fb2a680e22093447d48ac", version: 192 }),
                    Box::new(Tree::Leaf { script: "06424950333431", version: 250 }),
                )),
                leaf_hashes: &[
                ...
                merkle_root: Some("6c2dc106ab816b73f9d07e3cd1ef2c8c1256f519748e0813e4edd2405d277bef"),
            ...
            Vector {
                ...
                tree: Some(Tree::Node(
                    Box::new(Tree::Leaf { script: "2044b178d64c32c4a05cc4f4d1407268f764c940d20ce97abfd44db5c3592b72fdac", version: 192 }),
                    Box::new(Tree::Leaf { script: "07546170726f6f74", version: 192 }),
                )),
                leaf_hashes: &[
                ...
                merkle_root: Some("ab179431c28d3b68fb798957faf5497d69c883c6fb1e1cd9f81483d87bac90cc"),
            ...
            Vector {
                ...
                tree: Some(Tree::Node(
                    Box::new(Tree::Leaf { script: "2072ea6adcf1d371dea8fba1035a09f3d24ed5a059799bae114084130ee5898e69ac", version: 192 }),
                    Box::new(Tree::Node(
                        Box::new(Tree::Leaf { script: "202352d137f2f3ab38d1eaa976758873377fa5ebb817372c71e2c542313d4abda8ac", version: 192 }),
                        Box::new(Tree::Leaf { script: "207337c0dd4253cb86f2c43a2351aadd82cccb12a172cd120452b9bb8324f2186aac", version: 192 }),
                    )),
                )),
                leaf_hashes: &[
            ...
            Vector {
                ...
                tree: Some(Tree::Node(
                    Box::new(Tree::Leaf { script: "2071981521ad9fc9036687364118fb6ccd2035b96a423c59c5430e98310a11abe2ac", version: 192 }),
                    Box::new(Tree::Node(
                        Box::new(Tree::Leaf { script: "20d5094d2dbe9b76e2c245a2b89b6006888952e2faa6a149ae318d69e520617748ac", version: 192 }),
                        Box::new(Tree::Leaf { script: "20c440b462ad48c7a77f94cd4532d8f2119dcebbd7c9764557e62726419b08ad4cac", version: 192 }),
                    )),
                )),
                leaf_hashes: &[
                ...
                merkle_root: Some("2f6b2c5397b6d68ca18e09a3f05161668ffe93a988582d55c6f07bd5b3329def"),
        ...
        for vec in &vectors {
            ...
            let merkle_opt = if vec.tree.is_some() { Some(merkle_root) } else { None };
            ...
            if !vec.control_blocks.is_empty() {
                ...
                let calc_blocks: Vec<String> = leaves
                    ...
                    .collect();
                let expected: Vec<String> = vec.control_blocks.iter().map(|s| s.to_string()).collect();
